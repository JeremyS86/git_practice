...
//using luhn algorithm to check to see if a credit card is valid: passed test!
...
//checking all cards nested in batch array and returning all invalid card numbers to a new array.
const findInvalidCards = nestedArray => {
    let result = [];
    nestedArray.filter(array => {
        let arr = validateCred(array);
        if (arr === false) {
            result.push(array);
        }
    });
